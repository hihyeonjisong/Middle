...
public class T01FileTest {
	public static void main(String[] args) throws IOException {
		...
		//=> 디렉토리와 디렉토리 사이 또는 디렉토리와 파일명 구분문자는
		//	'\'(윈도우일때)를 사용하거나 '/'를 사용할수 있다.
		
		 File file = new File("d:/D_Other/test.txt");
		 System.out.println("파일명:"+file.getName());
		 System.out.println("파일여부 :"+file.isFile());//파일인지 아닌지 알고싶을때
		 ...
		 //=>'parent'디렉토리 안에 있는,'chile'파일 또는 디렉토리를 갖는다.
		 File file3 = new File(file2,"test.txt");
		 System.out.println(file3.getName()+"의 용량 크기: "
				 +file3.length()+"(bytes)"); //바이트 단위
		 ///////////////////////////////////////////
		 ...
		 /*
		  ...
		  (make directory)  중간의 경로가 모두 미리 만들어져 있어야한다.
