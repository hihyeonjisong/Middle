...
/*
	...
	열거형 선언하는 방법
	 enum 열거형 이름 {상수값1,상수값2, 상수값3, ..., 상수값4};
 */
...
public class T02EnumTest {
	...
	//데이터 값을 정해 줄 경우에는 생성자를 만들어서 괄호속의 값을 읽어올 수 있다.
	public enum Season {
		...
		*/
		...
		/*
		 	...
		 	2. ordinal() => 열거형 상수가 정의된 순서값을 반환한다.
		 					(기본적으로 0부터 시작)
		 	3. valueOf("열거형상수이름"); => 지정된 열거형에서 '열거형상수이름'
		 								과 일치하는 열거형 상수를 반환한다.
		 */
		City myCity1;
		City myCity2;
		...
		System.out.println(City.대전 == City.대전);
