package kr.or.ddit.basic;//고치기

public class T19WaitNotifyTest {
/*
 wait()메서드 -> 동기화 영역에서 락을  풀고 Wait-Set영역(공유객체별 존재)으로 이동시킨다.
 notify() 또는 notifyAll()메소드 ->Wait-Set영역에 있는 스레드를 깨워서 실행(RUNNABLE)될수 있도록 한다.
...
// WorkObject 의 methodA()만 호출하는 스레드
...
// WorkObject 의 methodB()만 호출하는 스레드
