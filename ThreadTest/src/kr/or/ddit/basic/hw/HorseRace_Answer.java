...
class Horse extends Thread implements Comparable<Horse> {
	...
	public void run() {
		...
		this.rank = HorseRace_Answer.rank;
		HorseRace_Answer.rank++;
	}
...
class HorsePositionDisplay extends Thread {
	...
	public void run() {
		...
		while (true) {
			...
			for (int i = 0; i < HorseRace_Answer.horseList.size(); i++) {

				String horseCourse = "--------------------------------------------------"; // 50구간
				Horse horse = HorseRace_Answer.horseList.get(i);
